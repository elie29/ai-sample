...
| Execution | `superpowers:executing-plans` or `superpowers:subagent-driven-development` | ticks tasks in the plan file | reviews each task, then commits |
...
- A specification without numbered invariants is not ready for the security review.
